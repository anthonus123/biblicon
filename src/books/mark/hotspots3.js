...
// over src/img/<key>.webp (BOOK=mark python3 src/tools/grid.py OUT KEY) and checked by drawing
// them back (BOOK=mark python3 src/tools/overlay.py OUT). Keep every coordinate inside 9–92;
// assemble.js clamps outside that.
module.exports={

// ---- chapter 1 ----

"File:St John the Baptist Late XVII - Early XVIII Cenury St Mary Blonichka Church, Ohris Icon Gallery.jpg":[
 ["The wings", "The Forerunner is the only man the Church paints with wings. It is not a claim that he was an angel: Mark's first quotation calls him a messenger — Behold, I send my messenger before thy face — and the Greek word behind it is the same word as angel. The painter has taken the Evangelist at his word.", "24%", "88%"],
 ["The face", "Gaunt, hollow-eyed, the hair matted and undivided. Greek painters give him the face of a man who has lived on locusts and wild honey, which is Mark's next detail after the camel's hair.", "18%", "50%"],
 ["The camel's hair", "The shaggy brown hide thrown over his shoulder is what Mark describes: John was clothed with camel's hair, and with a girdle of a skin about his loins. The prophet's dress is deliberate — it is how the Books of Kings describe Elias, and the Church reads the likeness.", "42%", "36%"],
 ["The scroll", "ΜΕΤΑΝΟΕΙΤΕ ΗΓΓΙΚΕΝ ΓΑΡ Η ΒΑΣΙΛΕΙΑ ΤΩΝ ΟΥΡΑΝΩΝ — Repent ye: for the kingdom of heaven is at hand. That is Matthew's wording of the preaching. Mark reports the same preaching in his own words, the baptism of repentance for the remission of sins, and gives no sermon.", "38%", "69%"],
 ["His own head in the charger", "In the dish at his side lies his severed head, painted while the living man stands above it. The icon puts the end of his life beside its beginning, and that is why it belongs to the Forerunner himself rather than to any one passage: the Church never shows him without his martyrdom.", "73%", "68%"],
],

"File:Baptism of Christ, Early XIV Century, St Mary Perivleptos Church, Ohrid Icon Gallery.jpg":[
 ["The heavens opened", "A dark segment of sky is cut into the gold at the top and a shaft comes down out of it. Mark's verb is the violent one: he saw the heavens opened — torn apart — where Matthew and Luke have them merely open.", "15%", "45%"],
 ["The Forerunner's hand", "He reaches across from the bank and lays his hand on Christ's head. Mark gives the whole act in six words, was baptized of John in Jordan, and the icon keeps it that spare: no crowd, no Pharisees, no protest.", "40%", "37%"],
 ["Christ in the Jordan", "He stands upright in the water rather than kneeling, and blesses the river with his right hand. The Church reads the descent as the blessing of all water; the Evangelist only says he came up out of the water.", "52%", "47%"],
 ["The waiting angels", "Four angels on the far bank with their hands wrapped in their cloaks, the courtesy of a servant before a king, ready to receive him from the river. They are the Church's addition to the scene, not Mark's: he mentions no-one but John and the voice.", "43%", "71%"],
 ["The Jordan and the sea", "Two small figures turn away at Christ's feet — an old man reclining, and a rider on a sea-beast. They are the river Jordan and the sea of the psalm the Church sings at this feast: the sea saw it, and fled; Jordan was driven back.", "82%", "58%"],
 ["The axe at the root", "An axe leans against the root of a tree at the foot of the bank. That is the Forerunner's warning in Matthew and Luke. Mark reports none of his preaching except the promise of one mightier, so this corner of the picture is the other Evangelists', not his.", "61%", "17%"],
],

"File:019 Baptism of Jesus Icon from Saint Paraskevi Church in Langadas.jpg":[
 ["The torn sky", "The painter has opened a wide gold wound in the dark heaven, far larger than the neat segment older icons use. It answers Mark's word exactly — the heavens opened, rent — and it is the thing this village hand cared most about.", "18%", "22%"],
 ["The shaft of light", "A red-orange beam comes down the whole height of the panel to Christ's head. The dove is not painted here; the descent itself is, which is what Mark names next: the Spirit like a dove descending upon him.", "36%", "50%"],
 ["The Forerunner's hand", "His right hand on Christ's head, a scroll held in his left. He is painted stepping down off the rock, still in his camel's hair.", "47%", "41%"],
 ["Christ in the water", "Waist-deep in a blue-green Jordan, one hand at his breast. Mark's account is over in three verses and has no dialogue in it at all.", "56%", "52%"],
 ["The angels", "Two angels crowd the right bank with their arms wrapped in their cloaks.", "50%", "77%"],
 ["The trees", "Flat dark discs on bare stems, the convention of these Greek village panels for the wilderness where John did baptize.", "25%", "25%"],
],

"File:03 Baptism of Christ Icon from Saint Paraskevi Church in Adam.jpg":[
 ["The dove", "A white bird at the centre of the cloud, the only one of the four Theophanies here that paints it. Mark: the Spirit like a dove descending upon him.", "22%", "52%"],
 ["The rays", "A spray of fine rays runs from the dove to Christ's head, so that the opening of the heavens and the descent of the Spirit are one movement in the eye, as they are one sentence in Mark.", "31%", "55%"],
 ["The cloud", "Banks of grey-green cloud fill the top of the panel instead of the usual segment of heaven — a later Greek way of painting the same thing.", "20%", "30%"],
 ["The Forerunner's hand", "His hand on Christ's head; he steps down from the rock on the left.", "38%", "44%"],
 ["Christ", "Mark alone puts the whole event in Christ's own sight and hearing: he saw the heavens opened, and the voice speaks to him, not about him — Thou art my beloved Son. The icon keeps that privacy: there is no crowd.", "46%", "52%"],
 ["The angel with the cloth", "The nearest of the three angels holds a folded cloth ready. Mark says nothing of them; the Church has painted them at this river since the earliest cycles.", "45%", "73%"],
],

"File:0663Ha. Hermitage Museum (Hall 143). Icon of the Epiphany.jpg":[
 ["The heavens torn open", "A dark triangle driven down into the gold, with rays falling from its point. Mark's word for it is the same word he will use at the end for the veil of the temple: torn.", "12%", "47%"],
 ["The dove", "A small white bird at the point of the rays, over Christ's head.", "28%", "49%"],
 ["The Forerunner's hand", "He bends almost double from the rock, one hand on Christ's head and the other raised to his own face. Mark gives him one line of speech before this: I indeed have baptized you with water: but he shall baptize you with the Holy Ghost.", "40%", "44%"],
 ["Christ in the water", "The body is painted thin and hard, the head bowed. This is not a serene bath; it is a descent.", "47%", "51%"],
 ["The Jordan as a grave", "Russian painters give the river as a black cleft standing almost upright around him, narrow at the bottom and opening above. The reading is the Church's: going down into the water is going down into death, and Mark's next words are that he came up out of the water.", "70%", "42%"],
 ["The angels with the cloth", "Three angels on the bank in graded reds and greens, heads bowed, hands covered, the nearest holding a white cloth. Their bowing says what the voice says in the next verse: Thou art my beloved Son, in whom I am well pleased.", "53%", "72%"],
],

"File:Christ's temptation (Monreale).jpg":[
 ["The tempter's words", "SI FILI DI ES DIC VT LAPIDES ISTI PANE FIA[NT] — If thou be the Son of God, command that these stones be made bread. Matthew and Luke give this exchange; Mark does not. He says only that Christ was tempted of Satan forty days.", "10%", "65%"],
 ["Christ's answer", "On the left, [SCRI]PTV[M] E[ST] NON IN SOLO PANE V[IVIT HO]MO — It is written, man shall not live by bread alone. Again the words are the other Evangelists'. What Mark supplies is the outcome: the tempter got nothing.", "20%", "10%"],
 ["The five stones", "Round white stones lie on the ground between them, the thing asked for. The mosaicist has made the whole argument visible in one object.", "62%", "60%"],
 ["The devil", "Black, gaunt and winged, leaning in with an open hand. Byzantine painters give the fallen angel his wings still: what he lost was the light, not the nature.", "35%", "76%"],
 ["The scroll in Christ's hand", "Closed, held against his body. He is not reading from it; the word he answers with is already his.", "38%", "39%"],
 ["The wilderness", "A bare stony hill with a few dry shrubs. Mark's two verses put him here forty days, and add what no other Evangelist does — that he was with the wild beasts. None is painted in this mosaic.", "74%", "30%"],
],

"File:Elkomenos Prodromos Phylaken Dionysiou.jpg":[
 ["The inscription", "ΕΛΚΟΜΕΝΟΣ Ο ΠΡΟΔΡΟΜΟΣ ΕΙΣ ΤΗΝ ΦΥΛΑΚΗΝ — the Forerunner dragged into the prison. The painted title is what fixes this fresco to this moment and not to any other in his life.", "9%", "50%"],
 ["The bound wrists", "The soldier has both his wrists in one fist. This is the arrest itself, and it is the event behind Mark's half-line: Now after that John was put in prison, Jesus came into Galilee.", "48%", "57%"],
 ["The Forerunner", "He leans back against the pull, barefoot, in the same camel's hair he wore at the river. Mark has already finished with him as a preacher; from here his imprisonment is only the hinge that starts the preaching of Christ.", "27%", "47%"],
 ["The soldier", "In a plumed helmet and scaled corselet, hauling with both arms, painted a head taller than his prisoner.", "32%", "68%"],
 ["The prison", "A pale stone tower with a barred window on the right, and two faces already looking out through the bars. Mark will not open that door again: the next time he speaks of John it is to report his death at Herod's table.", "38%", "87%"],
...
"File:Judas receiving money, icon of Yaroslavl (19 c, priv.coll).jpg":[
 ["Judas", "He stands at the left, bearded and unhaloed, his bare hand laid on the edge of the cloth. Mark gives him no words at all here — he went unto the chief priests, to betray him unto them — where Matthew has him open the bargain himself with what will ye give me.", "45%", "21%"],
...
"File:Stavrosis Dionysiou.jpg":[
 ...
 ["The thief on his left", "Roped to his cross, his head thrown back. Mark does not tell the two apart; in the next passage, And they that were crucified with him reviled him.", "27%", "86%"],
 ...
 ["St John", "Ο Α(ΓΙΟΣ) ΙΩ(ΑΝΝΗΣ) Ο ΘΕΟΛΟΓΟΣ over his head, his hand at his cheek. His place here is from his own Gospel; in Mark's the disciples had gone at the arrest — they all forsook him, and fled.", "38%", "64%"],
 ["The centurion", "Haloed, with a round shield, his right hand raised. The letters above him begin Ο Α(ΓΙΟΣ) Λ…; the Church knows him as St Longinus. In Mark he is the centurion, which stood over against him.", "30%", "74%"],
...
"File:Crucifixion Icon Sinai 12th century.jpg":[
 ...
 ["The frame of saints", "Saints in medallions all round: apostles and archangels at the top about a bearded figure with a staff, bishops and martyrs down the sides, and along the bottom a crowned emperor and empress. Their names are written in red beside them, too small to read in this photograph.", "90%", "69%"],
],
...
"File:Emphania Soteros Dionysiou.jpg":[
 ...
 ["ΜΗ ΜΟΥ ΑΠΤΟΥ", "Touch me not, lettered beside Christ's head. The words are John's; Mark reports that the appearance happened and nothing that was said in it.", "19%", "43%"],
...
"File:Christos Apostolois Dionysiou.jpg":[
 ...
 ["His right hand", "Flung wide over the apostles at his right, the palm open.", "19%", "26%"],
 ["His left hand", "The same over those at his left. The breadth of the two arms is the breadth of the sending: Go ye into all the world, and preach the gospel to every creature.", "20%", "65%"],
 ["The apostles at his right", "Ranked shoulder to shoulder, haloed, grey heads and young ones together.", "30%", "16%"],
